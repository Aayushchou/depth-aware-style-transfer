...
if __name__ == "__main__":
    image_folder = "data/output/test/smoothed_frames"
    output_video = "data/output/video/dast_smoothed.mp4"
    frame_rate = get_frame_rate("data/input/video/1am_trimmed.mp4")
    images_to_video(
